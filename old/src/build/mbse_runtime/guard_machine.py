...
CALLABLE_PLANS_BY_ID = {"guard_node:job_check:guard:0": HsmGeneratedRuntimeCallablePlan(plan_id="guard_node:job_check:guard:0", module="tests.support.hsm_callable_fixtures", name="guard_job_available")}

ON_INITIAL_PLAN_IDS_BY_STATE = {"idle": (), "processing": (), "blocked": ()}

ON_ENTRY_PLAN_IDS_BY_STATE = {"idle": (), "processing": (), "blocked": ()}

ON_EXIT_PLAN_IDS_BY_STATE = {"idle": (), "processing": (), "blocked": ()}

EVENT_CANDIDATE_ROWS_BY_STATE = {"idle": (HsmGeneratedRuntimeEventCandidateRow(candidate_id="idle_to_job_check", event_id="advance_evt", source_id="idle", kind="external_transition", target_id="job_check", guard_plan_id="guard_node:job_check:guard:0", guard_node_id="job_check", guard_true_branch=HsmGeneratedRuntimeGuardBranchRow(branch_id="job_check_true", target_id="processing", activity_plan_ids=()), guard_false_branch=HsmGeneratedRuntimeGuardBranchRow(branch_id="job_check_false", target_id="blocked", activity_plan_ids=()), activity_plan_ids=()),), "processing": (), "blocked": ()}
