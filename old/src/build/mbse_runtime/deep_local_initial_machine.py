...
CALLABLE_PLANS_BY_ID = {"state:child:on_entry:0": HsmGeneratedRuntimeCallablePlan(plan_id="state:child:on_entry:0", module="tests.support.hsm_callable_fixtures", name="trace_child_entry"), "state:leaf:on_entry:0": HsmGeneratedRuntimeCallablePlan(plan_id="state:leaf:on_entry:0", module="tests.support.hsm_callable_fixtures", name="trace_leaf_entry"), "state:parent:on_entry:0": HsmGeneratedRuntimeCallablePlan(plan_id="state:parent:on_entry:0", module="tests.support.hsm_callable_fixtures", name="trace_parent_entry"), "state:parent:on_initial:0": HsmGeneratedRuntimeCallablePlan(plan_id="state:parent:on_initial:0", module="tests.support.hsm_callable_fixtures", name="trace_parent_initial")}

ON_INITIAL_PLAN_IDS_BY_STATE = {"parent": ("state:parent:on_initial:0",), "child": (), "leaf": ()}
